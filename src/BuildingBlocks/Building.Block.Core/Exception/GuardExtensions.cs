...
namespace Building.Blocks.Core.Exception;
...
public static class GuardExtensions
{
    ...
    public static string InvalidPhoneNumber(this IGuardClause guardClause, string countryCode , string phoneNumberWithOutCountryCode)
    {
        return guardClause.InvalidPhoneNumber(countryCode, phoneNumberWithOutCountryCode, new InvalidPhoneNumberException(countryCode,phoneNumberWithOutCountryCode));
    }
    ...
    {
        if (string.IsNullOrWhiteSpace(countryCode) || string.IsNullOrWhiteSpace(phoneNumberWithOutCountryCode) )
        {
            throw exception;
        }

        if (countryCode.Length < 2 || phoneNumberWithOutCountryCode.Length < 5)
        {
            throw exception;
        }

        if (phoneNumberWithOutCountryCode.Length > 15)
        {
            throw exception;
        }
