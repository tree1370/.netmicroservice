...
public static class RegistrationExtensions
{
    ...
    {
        var serilogOptions = new SerilogOptions { ElasticSearchUrl = "http://localhost:9200",
         SeqUrl= "http://localhost:5341" , LogPath= "./logs/webapi-.log", 
            LogTemplate = "[{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} {CorrelationId} {Level:u3}] {Username} {Message:lj}{NewLine}{Exception} Ip Address Client: {RemoteIpAddress} RequestScheme : {RequestScheme} RequestHost : {RequestHost} RequestMethod : {RequestMethod} RequestPath : {RequestPath} StatusCode : {StatusCode}"
